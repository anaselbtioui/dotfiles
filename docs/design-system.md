...
Canon for this machine and for apps you control. Stay on **Ubuntu GNOME**. No
new desktop environment. Core color is
...
photos that turn dock translucency into mud.
